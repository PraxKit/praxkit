...
We do our best to keep the issue tracker tidy and organized, making it useful for everyone. For example, we classify open issues per perceived difficulty, making it easier for developers to [contribute to PraxKit](#pull-requests).
...
Feature requests are welcome and should be discussed with the issue tracker. But take a moment to find out whether your idea fits with the scope and aims of the project. It's up to _you_ to make a strong case to convince the community of the merits of this feature. Please provide as much detail and context as possible.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/PraxKit
...
1. Create a new topic branch (off of `master`) to contain your feature, change,
   or fix.
...
1. Commit your changes in logical chunks. Keep your commit messages organized,
...
1. If you modified the controllers in `web/controllers/` you need
   to run a mix task to copy those files to `priv/templates/PraxKit.install/controllers`.

   ```bash
   mix PraxKit.make_templates
   ```

1. [Open a Pull Request](https://help.github.com/articles/using-pull-requests/)
   with a clear title and description.

1. If you haven't updated your pull request for a while, you should consider
