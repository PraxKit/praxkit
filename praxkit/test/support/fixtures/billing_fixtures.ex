defmodule Praxkit.BillingFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Praxkit.Billing` context.
  """

  import Praxkit.AccountsFixtures

  alias Praxkit.Billing.{Product, Products, Plans, Customers, Subscriptions, Invoices}
