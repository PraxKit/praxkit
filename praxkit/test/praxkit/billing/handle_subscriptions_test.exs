defmodule Praxkit.Billing.HandleSubscriptionsTest do
  use Praxkit.DataCase

  import Praxkit.BillingFixtures

  alias Praxkit.Billing.Subscription
  alias Praxkit.Billing.Subscriptions
