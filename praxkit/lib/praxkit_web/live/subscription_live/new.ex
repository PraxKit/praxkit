defmodule PraxkitWeb.SubscriptionLive.New do
  use PraxkitWeb, :live_view

  import Ecto.Changeset
  import PraxkitWeb.App.AccountAndUserLoader
  ...
  def mount(_params, session, socket) do
    ...
    %{account: account} = account_and_user_from_session(session)
    customer = Billing.get_billing_customer_for_account(account)
