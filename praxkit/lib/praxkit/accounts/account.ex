defmodule Praxkit.Accounts.Account do
  use Praxkit.Schema
  ...
  schema "accounts" do
    ...
    has_many :users, Praxkit.Accounts.User
    has_one :billing_customer, Praxkit.Billing.Customer
  ...
  def registration_changeset(account, attrs) do
    ...
    |> cast_assoc(:users, with: {Praxkit.Accounts.User, :changeset, []})
    |> set_token(account)
  end
