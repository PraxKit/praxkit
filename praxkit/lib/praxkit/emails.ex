defmodule Praxkit.Emails do
  import Swoosh.Email
  use Phoenix.Swoosh, view: PraxkitWeb.EmailView, layout: {PraxkitWeb.LayoutView, :email}
  ...
  @doc """
  This email is used by pow for sending password recovery and email confirmation
  """
  def pow_email(%{user: user, subject: subject, text: _text, html: html}) do
    base_email()
    |> to(user.email)
    |> subject(subject)
    |> render_body("pow_email.html", title: subject, preheader: subject, html: html)
    |> premail()
  end
