defmodule Praxkit.InAppNotifications do
  @moduledoc """
  ...
  alias Praxkit.InAppNotifications.Notification
  ...
  defp notify_subscribers({:ok, notification} = result) do
    Phoenix.PubSub.broadcast(Praxkit.PubSub, "notification:#{notification.user_id}", %{notification: notification})
    result
  end
  ...
  def subscribe_on_notification_created(user_id) do
    Phoenix.PubSub.subscribe(Praxkit.PubSub, "notification:#{user_id}")
  end
end
