defmodule Praxkit.Billing.WebhookProcessor do
  @moduledoc """
  """
  use GenServer
  ...
  alias Praxkit.Billing.HandleSubscriptions
  alias Praxkit.Billing.HandleInvoices
  alias Praxkit.Billing.HandlePaymentMethods
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Praxkit.PubSub, "webhook_processed")
  end

  def notify_subscribers(event) do
    Phoenix.PubSub.broadcast(Praxkit.PubSub, "webhook_processed", {:event, event})
  end
