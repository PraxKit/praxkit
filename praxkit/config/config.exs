...
config :praxkit, PraxkitWeb.Endpoint,
  ...
  live_view: [signing_salt: "21Q89Ar9"]
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js vendor/fonts/InterWeb/inter.css --bundle --loader:.woff2=file --loader:.woff=file --target=es2016 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
