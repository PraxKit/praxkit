defmodule Praxkit.Accounts.User do
  ...
  schema "users" do
    ...
    field :avatar, Praxkit.AvatarUploader.Type
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Praxkit.Repo)
  ...
  """
  def valid_password?(%Praxkit.Accounts.User{hashed_password: hashed_password}, password)
